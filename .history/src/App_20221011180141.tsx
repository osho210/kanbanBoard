      ...
      <MainArea>
        <HorizontalScroll>
          {columns.map(({ id: columnID, title, cards, text }) => (
            ...
            />
            型 '{ id: string; text?: string | undefined; }[] | undefined' を型 '{ id: string; text?: string | undefined; }[]' に割り当てることはできません。
          型 'undefined' を型 '{id: string; text?: string | undefined; }[]' に割り当てることはできません。
          ))}
        </HorizontalScroll>
      </MainArea>
      {deletetingCardID && (
